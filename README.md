...
- **versionFormat** - exact, detect, autodetect, template
    ...
    - **detect** - Try to detect the version from sources. Will fail if no sources found. Must use https://github.com/actions/checkout! See [example](https://github.com/ServiceNow/sncicd_githubworkflow/blob/master/workflow_publish_with_detect.yml).
