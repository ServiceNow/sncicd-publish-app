    ...
    getCurrentAppVersionTableApi(appSysID) {
        if (appSysID) {
            return axios_1.default
                .get(`https://${this.props.nowSourceInstance}.service-now.com/api/now/table/sys_app/${appSysID}?sysparm_fields=version`, this.config)
                .then((response) => {
            ...
            return axios_1.default
                .get(`https://${this.props.nowSourceInstance}.service-now.com/api/now/table/sys_app?sysparm_fields=scope,version`, this.config)
                .then((response) => {
